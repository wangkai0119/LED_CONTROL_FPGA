...
// i2c device address
`define I2C_ADDRESS_CTRL 7'h50
`define I2C_ADDRESS_PWM 7'h51
`define I2C_ADDRESS 7'h28
...
// 3 ticks = 250nS @ 12MHz
`define DEB_I2C_LEN (10*`CLK_FREQ)/`CLK_FREQ
...
// 10 ticks = 208nS @ 48MHz
// 6 ticks = 500nS @ 12MHz
`define SCL_DEL_LEN (10*`CLK_FREQ)/`CLK_FREQ
...
// 4 ticks = 83nS @ 48MHz
// 3 ticks = 250nS @ 12MHz
`define SDA_DEL_LEN (4*`CLK_FREQ)/`CLK_FREQ
